const comments = {
  ...
  "BAPIPRjQce9": [
    {
      ...
      "text": "I like baby pancakes but gluten free please!! I'll bring the coffee!! See you in" +
          " 6 days!!!!!! 😝😛😝♥️",
      "user": "terzisn"
    }, {
      ...
      "text": "Genius bottle use! Do you make a single batch of batter or make a lot and freeze" +
          " it?",
      "user": "gobananna"
    }, {
      "text": "@gobananna I just made a batch and put in in a FIFO bottle. Keeps in the fridge " +
          "for a few days.",
      "user": "wesbos"
    }, {
  ...
  "BAF_KY4wcRY": [
    {
      ...
      "text": "I've never caught your podcast. Have one right? Btw - they don't have a Canary p" +
          "illow? 😝",
      "user": "henrihelvetica"
    }, {
      ...
      "text": "@axcdnt that is where I put all the junk. I'll have to clean that side too @henr" +
          "ihelvetica no podcast yet! @pmgllc ohh yeah! @alexbaumgertner yep - the main one" +
          " is 4K - I'm loving it",
      "user": "wesbos"
    }, {
      ...
      "text": "@wesbos is that the Dell 4k? The MacBook Pro powers it well? I also have a Retin" +
          "a™ / x1 setup as well. Very handy.",
      "user": "henrihelvetica"
    }, {
      "text": "#minimalsetups",
      "user": "wesbos"
  ...
  "_zbaOlQcbn": [
    {
      ...
      "text": "Nope @pathiebert! She has too much teeth now (8) so that would definitely be her" +
          " first cavity 😉",
      "user": "kaitbos"
    }
  ],
  ...
  "_XpJcrwcSn": [
    {
      ...
      "text": "real live paper magazine? woah haha. flex box is awesome though, could rage quit" +
          " without it",
      "user": "tjholowaychuk2"
    }, {
  ...
  "1rhFawccs": [
    {
      ...
      "text": "And what are you using for XLR mix adapter? I found a big price jump between $55" +
          " range and $170 range.",
      "user": "pmgllc"
    }, {
  ...
  "hZh6IQcfN": [
    {
      ...
      "text": "Might drop by today - real quick. Trade you an illegal pin for these? Lol. @wesb" +
          "os",
      "user": "henrihelvetica"
    }, {
  ...
  "FpTyHQcau": [
    {
      ...
      "text": "@courtneyeveline I know! My friend gave it to her and I wanted a matching one bu" +
          "t only Lux can pull it off. She's so fancy 😉",
      "user": "kaitbos"
    }, {
  ...
  "B3eiIwcYV": [
    {
      "text": "If you get in the mood for authentic Italian pizza, check out @backspaceaustin -" +
          " it's👌🏻",
      "user": "dessie.ann"
    }, {
      "text": "😱 jealous",
